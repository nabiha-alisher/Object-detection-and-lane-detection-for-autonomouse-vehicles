...
# ──────────────────────────────────────────────────────────────
TRITON_URL = os.environ.get("TRITON_HTTP_URL", os.environ.get("TRITON_URL", "localhost:8000"))
...
if __name__ == "__main__":
    ...
    suffix = os.environ.get("FPS_NAME_SUFFIX", "fps_http_parallel_v2")
    lane_strategy = os.environ.get("FPS_LANE_STRATEGY", "corridor_memory_two_hits")

    print("\n=== FPS VARIANT START ===")
    print("variant:", "http_parallel")
